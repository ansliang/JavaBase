...
public class TextLex{
	...
	// 关键字
	private static String [] Key={"private","protected","public","abstract","class","extends","final","implements",
			"interface","native","new","static","strictfp","synchronized","transient","volatile","break","case","continue",
			"default","do","else","for","if","instanceof","return","switch","while","assert","catch","finally","throw","throws",
			"try","import","package","boolean","byte","char","double","float","int","long","short","null","super","this","void", "sizeof","const"};
	...
	public void printError(int row_num, String rs_value, String rs_name) {
		System.err.println(row_num+": "+rs_value+"			"+rs_value);
	}
